...
if (!file("$params.assembly_dir").exists()) {
    error("Input file '$params.assembly_dir' was not found. Either add it to the data directory, or specify another assembly list using --ftp_file")
}
...
workflow MULTIPLEFAST {
    ...
    def assembly_ch = Channel.fromPath(params.assembly_dir + "/*.fna.gz")
